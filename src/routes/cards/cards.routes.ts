...
const cards_routes = () => {
    ...
    routes.get('/:id', authTokenMiddleware, isBlockedMiddleware, viewCardController)
    routes.delete('/:id', authTokenMiddleware, isBlockedMiddleware, blockedCardController)
    routes.post('/:id', authTokenMiddleware, isUnlockMiddleware, unlockCardController)
